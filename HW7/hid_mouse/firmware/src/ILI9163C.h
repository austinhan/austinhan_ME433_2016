...
void display_character(unsigned short, unsigned short, unsigned char); // write ASCII chars to LCD
void drawString(unsigned short, unsigned short, char*); // write string to LCD
